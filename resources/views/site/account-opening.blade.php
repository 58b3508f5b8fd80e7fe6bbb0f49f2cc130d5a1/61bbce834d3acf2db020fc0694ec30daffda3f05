...
<head>
    ...
    <link href="public/css/70969.css?ts=1515221880" rel="stylesheet" type="text/css"/>
...
<div class="root">
    <div class="vbox wb_container" id="wb_header">
        ...
        <div class="wb_cont_inner">
            <div id="wb_element_instance114" class="wb_element wb-menu">
                <ul class="hmenu">
            ...
            <div id="wb_element_instance115" class="wb_element wb_element_shape">
                <div class="wb_shp"></div>
            </div>
            <div id="wb_element_instance116" class="wb_element" style=" line-height: normal;"><h1
                        class="wb-stl-heading1"><span style="background-color:#ffffff;">TLSavings</span></h1>
            </div>
            <div id="wb_element_instance117" class="wb_element wb_element_picture"><img alt="gallery/tlsavings jpg"
    ...
    <div class="vbox wb_container" id="wb_main">
        ...
        <div class="wb_cont_inner">
            <div id="wb_element_instance119" class="wb_element" style=" line-height: normal;"><p class="wb-stl-normal"
            ...
            <div id="wb_element_instance120" class="wb_element" style=" line-height: normal;"><h1
                        class="wb-stl-heading1">About us</h1></div>
            <div id="wb_element_instance121" class="wb_element" style=" line-height: normal;"><h1
                        class="wb-stl-heading1">Our team</h1></div>
            <div id="wb_element_instance122" class="wb_element"><a class="wb_button"
                                                                   href="{{url('index-3')}}><span></span></a></div><div id="
                                                                   wb_element_instance123" class="wb_element"><a
                        class="wb_button" href="{{url('index-3')}}><span></span></a></div><div id="
                        wb_element_instance124" class="wb_element"><a class="wb_button"
                                                                      href="{{url('index-3')}}><span></span></a></div><div id="
                                                                      wb_element_instance125" class="wb_element"><a
                        class="wb_button" href="{{url('index-2')}}><span></span></a></div><div id="
                        wb_element_instance126" class="wb_element" style="width: 100%;">
    ...
    <div class="vbox wb_container" id="wb_footer">
        ...
        <div class="wb_cont_inner" style="height: 104px;">
            <div id="wb_element_instance118" class="wb_element" style=" line-height: normal;"><p class="wb-stl-footer">©
                    2018 <a href="{{url('index')}}>tlsavings.xyz</a></p></div><div id=" wb_element_instance127"
